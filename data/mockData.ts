...
export const MOCK_MESSAGES = [
  { id: "m1", from: "Sarah K.", preview: "Hey! Excited about Bali?", time: "2m ago", unread: true },
  {
    id: "m2",
    from: "James M.",
    preview: "Found a great hostel in Shibuya",
    time: "1h ago",
    unread: false,
  },
];
...
export const MOCK_TESTIMONIALS = [
  {
    name: "Alex T.",
    location: "NYC",
    text: "Found my perfect travel buddy for Japan. We had an amazing time!",
    rating: 5,
  },
  {
    name: "Maria S.",
    location: "Madrid",
    text: "Safe, fun, and so easy to use. Highly recommend!",
    rating: 5,
  },
  {
    name: "David L.",
    location: "Berlin",
    text: "Met two travel buddies through the app. Best trip ever.",
    rating: 5,
  },
];
...
export const BUDGET_OPTIONS = ["Budget", "Medium", "Luxury"];
