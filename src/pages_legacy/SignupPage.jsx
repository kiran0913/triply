    ...
    <div className="min-h-screen bg-gradient-mesh flex">
      <div className="flex-1 flex items-center justify-center p-8">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="w-full max-w-md">
          <Link to="/" className="text-2xl font-bold tracking-tight bg-gradient-to-r from-primary-600 to-primary-500 bg-clip-text text-transparent">Travel Buddy</Link>
          <h1 className="mt-10 text-3xl font-bold text-gray-900 tracking-tight">Create your account</h1>
          <p className="mt-2 text-gray-600">Join thousands of travelers finding their perfect buddy</p>
      ...
      <div className="hidden lg:block lg:w-1/2 bg-gradient-hero relative">
        <img src="https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=800&h=1000&fit=crop" alt="Travel" className="absolute inset-0 w-full h-full object-cover opacity-70" />
