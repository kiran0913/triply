        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="mt-3 text-gray-600 text-sm max-w-xs leading-relaxed">
              Connect with like-minded travelers. Find your perfect companion for unforgettable adventures.
            </p>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <Link to="/explore" className="text-sm text-gray-500 hover:text-gray-900 transition-colors">Explore Trips</Link>
              <Link to="/matches" className="text-sm text-gray-500 hover:text-gray-900 transition-colors">Find Matches</Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              {links.map((l) => (
                <Link key={l.to} to={l.to} className="text-sm text-gray-500 hover:text-gray-900 transition-colors">{l.label}</Link>
              ))}
            </div>
          </div>
        </div>
        <div className="pt-8 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-400 text-sm">© 2025 Travel Buddy. All rights reserved.</p>
          <p className="text-gray-400 text-sm">Find your perfect travel companion.</p>
        </div>
      </div>
    </footer>
  );
