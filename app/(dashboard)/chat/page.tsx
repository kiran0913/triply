...
export default function ChatPage() {
  ...
  // Realtime: poll for new messages when conversation is open
  useEffect(() => {
  ...
  // Realtime: poll conversations list to refresh last-message previews in sidebar
  useEffect(() => {
  ...
  return (
    ...
    <div className="min-h-[400px] flex flex-col lg:flex-row gap-6 pb-20 md:pb-0 w-full min-w-0">
      ...
      {/* Trip planning sidebar - placeholder */}
